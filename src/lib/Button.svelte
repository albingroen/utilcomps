<script lang="ts">
	...
	const buttonStyles = {
		base:
			'flex items-center justify-center space-x-2.5 relative border-none text-white text-sm rounded-md py-1 px-3 transition cursor-default focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed',
		colors: {
			warning:
			...
			primary: 'bg-blue-600 active:bg-blue-500 focus:bg-blue-500 disabled:bg-blue-600'
		},
		block: 'w-full'
	};
</script>
